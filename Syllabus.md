...
| November 18 | 2 | The Project, the Pipeline, Installing Software II SRA Toolkit, Project Initiation, Running Jobs with Slurm, Data Acquisition | Reading 2 **(due ...)** | Assignment 2 **(due Dec. 4th)** | Quiz 2 **(due ...)** |
...
| December 2 | 4 | Automation I, Alignment, Building Indexes |  | Assignment 4 **(due Dec. 4th)** | Quiz 3 **(due ...)** |
| December 4 | 4 | Alignment | Reading 4 **(due ...)** | Assignment 5 **(due Dec. 4th)** |  |
