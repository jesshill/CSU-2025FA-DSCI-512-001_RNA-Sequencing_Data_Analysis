...
| Bonus Content | 1 | Tarballs & Gzipping, Nano: command line text editor | [Video link to tutorial of tarball download](https://zoom.us/rec/component-page?eagerLoadZvaPages=&accessLevel=meeting&action=viewdetailpage&sharelevel=meeting&useWhichPasswd=meeting&requestFrom=pwdCheck&clusterId=aw1&componentName=need-password&meetingId=tCHO-oNW5E8RQXUMW2YEBj9Od5__ysRRRE-ku1Wk-zCDjuY0Nt4PQxdXBwIfNzJ6.DRjBvjrTYmixVfXz&originRequestUrl=https%3A%2F%2Fzoom.us%2Frec%2Fshare%2F9_N4ArPU2l9LYc_jsRrACo0eI6X8eaa80SQcqPtexEcWyMaB7TbVkWJ7gYbepY9I%3FstartTime%3D1598531909000) Passcode: f$fQf2Lc, [List of Wildcards](https://tldp.org/LDP/GNU-Linux-Tools-Summary/html/x11655.htm)| |
...
| Bonus Content | 3 |  | [OnDemand RC CU Boulder](https://ondemand-rmacc.rc.colorado.edu), [Advanced sed](https://www.grymoire.com/Unix/Sed.html), [AWK command with examples](https://www.geeksforgeeks.org/linux-unix/awk-command-unixlinux-examples/), [fun article on why "Hello World"](https://slate.com/technology/2019/10/hello-world-history-programming.html), [Hello World in 30 different languages](https://www.geeksforgeeks.org/blogs/hello-world-in-30-different-languages/) | |
