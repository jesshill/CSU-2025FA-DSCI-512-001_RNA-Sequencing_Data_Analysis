...
- Create a new directory in your ALPINE scratch space where you will build this new hisat2 index
...
- For animal and yeast genomes, use either [UCSC genome browser](https://genome.ucsc.edu/) or [Ensembl](https://www.ensembl.org/index.html?redirect=no).
