...
Set your contrast expression: contrast=(a character vector with exactly three elements): 1) the name of a factor in the design formula, 2) the name of the numerator level for the fold change, and 3) the name of the denominator level for the fold change (simplest case)
